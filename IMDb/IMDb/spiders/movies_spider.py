...
class MoviesSpiderSpider(scrapy.Spider):
    ...
    def parse_movie_page(self,response):
        ...
        movie_item["country"] = response.css('li.ipc-metadata-list__item  div.ipc-metadata-list-item__content-container ul.ipc-inline-list.ipc-inline-list--show-dividers.ipc-inline-list--inline.ipc-metadata-list-item__list-content li.ipc-inline-list__item a[href*="country"]::text').get()
        movie_item["budget"] = response.css('section[data-testid="BoxOffice"] div.ipc-metadata-list-item__content-container ul.ipc-inline-list.ipc-inline-list--show-dividers.ipc-inline-list--inline.ipc-metadata-list-item__list-content li.ipc-inline-list__item span.ipc-metadata-list-item__list-content-item::text').get()
